#!/usr/bin/env python3
"""
Exp3: Binary Classification (With Personalization)
Performs AD vs CN classification using CTMS anomaly scores with personalized baselines.

Usage:
    python exp3_classification.py

Note:
    Uses individual personalized baselines (60% personal + 40% global) for each subject.
"""
