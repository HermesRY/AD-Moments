...
@article{your_paper_2025,
  title={Multi-dimensional Activity Pattern Analysis for Cognitive Function Assessment using CTMS Model},
...
- **Data Collection Team**: Clinical staff and participants
- **CTMS Model Development**: Original model authors
...
- **Principal Investigator**: [PI Name] ([email@institution.edu](mailto:email@institution.edu))
- **Lead Developer**: [Your Name] ([your.email@institution.edu](mailto:your.email@institution.edu))
- **Issues**: Please report bugs via [GitHub Issues](https://github.com/[YourUsername]/AD-Moments/issues)
...
- [ ] Implement cross-validation for Experiment 4
- [ ] Add support for additional clinical scores
...
This software is for **research purposes only**. It is not intended for clinical diagnosis or treatment decisions. Always consult qualified healthcare professionals for medical advice.

---

## 📈 Version History

- **v7.0.0** (2025-01-16): Initial release
  - Integrated best experiments from V5 (Exp 1-3) and V6 (Exp 4)
  - Achieved r=0.701*** MoCA correlation
  - Complete documentation and test suite

---

**Made with ❤️ for advancing cognitive health research**
